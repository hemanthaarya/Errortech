...
`
const ProductsContainer2=styled.div`
    display: flex;
    flex-direction: row;
    margin-top: -180px;
    width: 91vw;
    ...
    <div>
        ...
        <div className='OrangeContainer' style={toggleOn ? { backgroundColor: '#2c59c9'  } : null}>
            ...
            <div className='select1'>
                <Arrow><BiSolidChevronLeft style={{height:"30px",width:"30px"}}/></Arrow>
                <Arrow><BiSolidChevronRight style={{height:"30px",width:"30px"}}/></Arrow>
            </div>
        </div>
        <ProductsContainer2 id='slide'>
